...
public class FlappyBird extends JPanel implements ActionListener, KeyListener, MouseListener{
	...
	private static class RectangleImage {
	...
	private RectangleImage spiral = null;
...
public void rotateImage(double degrees, ImageObserver o){
	...
	Graphics2D g1 = (Graphics2D)blankCanvas.getGraphics();
	g1.rotate(Math.toRadians(degrees), icon.getIconWidth() / 2, icon.getIconHeight() / 2);
	g1.drawImage(this.img, 0, 0, o);
...
/*public void paint(Graphics g){
	...
	if(spiral == null){
		spiral = new RectangleImage(getImage("images/title.png"), 25, 20);
	}
}*/
